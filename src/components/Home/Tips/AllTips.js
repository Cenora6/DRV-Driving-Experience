...
export default class AllTips extends Component {
    ...
    handleQuiz = (prevState) => {
        ...
        const correct1 = tips[i - 1].test[0].correct;
        const correct2 = tips[i - 1].test[1].correct;
        const correct3 = tips[i - 1].test[2].correct;
                ...
                <>
                    <div className='tips__week' key={i}>
                        <div className='tips__week__title'>
                            ...
                            <h2>Weekly Tip</h2>
                            <span>{tips[i - 1].added}</span>
                        </div>
                        <div className='tips__week__description'>
                            <h3>{tips[i - 1].title}</h3>
                            <img src={tips[i - 1].photovideo} alt='weekly-tip'/>
                            <p>
                                {tips[i - 1].description}
                            </p>
                            <ul className='tips__week__description__tags'>
                                <li>
                                    <i className="fas fa-tags"></i>
                                </li>
                                {tips[i - 1].tags.map( (tag, index) => {
                                    return(
                                        <>
                            ...
                            <div className='test__questions__single'>
                                ...
                                <ul className='test__questions__single__photos'>
                                    <li className='radio'>
                                        ...
                                        <label htmlFor='2A'>
                                            <div className='image'>
                                                <img src={tips[i - 1].test[1].answer1[1]} alt='quiz'/>
                                            </div>
                                            <span>A.</span>{tips[i - 1].test[1].answer1[0]}
                                        </label>
                                        <div className="check"></div>
                                    </li>
                                    <li className='radio'>
                                        ...
                                        <label htmlFor='2B'>
                                            <div className='image'>
                                                <img src={tips[i - 1].test[1].answer2[1]} alt='quiz'/>
                                            </div>
                                            <span>B.</span>{tips[i - 1].test[1].answer2[0]}
                                    ...
                                    <li className='radio'>
                                        ...
                                        <label htmlFor='2C'>
                                            <div className='image'>
                                                <img src={tips[i - 1].test[1].answer3[1]} alt='quiz'/>
                                            </div>
                                            <span>C.</span>{tips[i - 1].test[1].answer3[0]}
                                        </label>
                                    </li>
                                </ul>
                            </div>
                            <div className='test__questions__single'>
                                <h4>{tips[i - 1].test[2].question}</h4>
                                <ul className='test__questions__single__text'>
                                    <li className='radio'>
                                        <input type='radio' id='3A' name='question3' onChange={this.checkAnswer3} value={"answer1"}/>
                                        <label htmlFor='3A'><span>A.</span>{tips[i - 1].test[2].answer1}</label>
                                        <div className="check"></div>
                                    </li>
                                    <li className='radio'>
                                        <input type='radio' id='3B' name='question3' onChange={this.checkAnswer3} value={"answer2"}/>
                                        <div className="check"></div>
                                        <label htmlFor='3B'><span>B.</span>{tips[i - 1].test[2].answer2}
                                        </label>
                                    </li>
                                    <li className='radio'>
                                        <input type='radio' id='3C' name='question3' onChange={this.checkAnswer3} value={"answer3"}/>
                                        <div className="check"></div>
                                        <label htmlFor='3C'><span>C.</span>{tips[i - 1].test[2].answer3}</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
